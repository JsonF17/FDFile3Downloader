...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FDFile3Downloader/FDFile3Downloader.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SJDownloadDataTask/SJDownloadDataTask.framework"
