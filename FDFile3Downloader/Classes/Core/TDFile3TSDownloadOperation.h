...
@interface TDFile3TSDownloadOperation : NSOperation
...
///
@property (nonatomic, copy, nullable) void(^downalodCompletionHandler)(TDFile3TSDownloadOperation *operation, NSError *_Nullable error);
